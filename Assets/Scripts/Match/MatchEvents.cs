...
public class MatchEvents {
	...
	public MatchEvents(Match match) {
		...
		playerContinuesTurn.AddListener(() => ui.setActivePlayerShotsLeft(match.isPlayerLeftActive(), match.getActivePlayer().getShotsLeft()));
		...
		playerScored.AddListener(() => ui.setActivePlayerScore(match.isPlayerLeftActive(), match.getActivePlayer().getScore()));
